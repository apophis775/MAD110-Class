...
public class MainActivity extends AppCompatActivity {
    ...
    public enum LoginSuccess{
        ...
        LoginSuccess(int value){intValue = value;}
    ...
    LoginSuccess CheckLogin(String txtLogin, String txtPassword){
        String holdLogin = "Dave";
        String holdPass = "password";


        if(!(holdLogin.equals(txtLogin))){return LoginSuccess.login;}


        if (!(holdPass.equals(txtPassword))){return LoginSuccess.password;}
